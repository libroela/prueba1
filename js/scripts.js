...
function initMonolit() {
    ...
    */
    ...
    $(".lightgallery").on("onBeforeNextSlide.lg", function(a) {
        ...
        gff.trigger("next.owl.carousel");
        ss.trigger("next.owl.carousel");
    });
    $(".lightgallery").on("onBeforePrevSlide.lg", function(a) {
        gR.trigger("prev.owl.carousel");
        gff.trigger("prev.owl.carousel");
    ...
    $(".show-hid-sidebar2").on("click", function(a) {
        a.preventDefault();
        $(".hid-sidebar2").addClass("vissb");
        setTimeout(function() {
    ...
    $("#contactform").submit(function() {
        ...
        $("#contactform").slideUp(400, function() {
			...
			$.post(a, {
                ...
                if (null != a.match("exito")) $("#contactform").slideDown("slow");
            });
        });
        return false;
    });
